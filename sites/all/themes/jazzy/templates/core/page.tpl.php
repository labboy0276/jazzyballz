...
<div id="page-wrapper"><div id="page">
   ...
   <!-- Page Header -->
  <header class="navbar navbar-default navbar-fixed-top <?php if ($hide_site_name && $hide_site_slogan && !$logo && !$main_menu && !$secondary_menu) { print ' element-invisible'; } ?>">
    <div class="container">
      <div class="navbar-header">
        ...
        <?php if ($logo): ?>
          <div class='brand navbar-brand'>
            <a href="#top" class="scrollto" rel="home" id="logo">
          ...
          <div id="site-name-slogan" class="brand navbar-brand <?php if ($hide_site_name && $hide_site_slogan) { print ' element-invisible'; } ?>">
            ...
            <?php if ($site_name): ?>
              <h1 id="site-name"<?php if ($hide_site_name) { print ' class="element-invisible"'; } ?>>
                <strong>
                  <a href="#top" class="scrollto" rel="home"><span><?php print $site_name; ?></span></a>
                </strong>
              </h1>
            <?php endif; ?>
